...
.field input,.field select,.field textarea{font-family:'Inter',sans-serif;font-size:14px;padding:12px 14px;border-radius:9px;border:1.5px solid var(--b);background:#fff;color:var(--t);transition:border-color .15s,box-shadow .15s;outline:none;width:100%}
...
.doc-item{border:1.5px solid var(--b);border-radius:12px;padding:18px 20px;background:#fff;transition:border-color .15s}
...
.doc-input{display:flex;align-items:center;gap:10px;padding:8px 12px;border-radius:7px;border:1px dashed var(--b);background:var(--f);cursor:pointer;transition:border-color .15s}
...
<div class="stepper-wrap" id="stepper-bar">
  <div class="stepper">
    <div class="step-tab active" id="tab-1"><div class="sn">1</div><div class="step-info"><p>Étape 1</p><strong>Gérant / DG</strong></div></div>
    <div class="step-tab" id="tab-2"><div class="sn">2</div><div class="step-info"><p>Étape 2</p><strong>Entreprise</strong></div></div>
    <div class="step-tab" id="tab-3"><div class="sn">3</div><div class="step-info"><p>Étape 3</p><strong>Documents</strong></div></div>
    <div class="step-tab" id="tab-4"><div class="sn">4</div><div class="step-info"><p>Étape 4</p><strong>Confirmation</strong></div></div>
  </div>
</div>

{{-- Le <form> enveloppe toutes les étapes pour que les fichiers (étape 3) soient bien soumis --}}
<form method="POST" action="{{ route('get-started.store') }}" enctype="multipart/form-data" id="mainForm">
@csrf
...
<section class="s step-section active" id="section-1">
  <div class="si">
    ...
    <div class="actions">
      <button type="button" class="btn-next" onclick="goTo(2)">Suivant<svg viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></button>
    </div>
  </div>
</section>
...
<section class="s step-section" id="section-2">
  <div class="si">
    ...
    <div class="actions">
      <button type="button" class="btn-prev" onclick="goTo(1)">← Retour</button>
      <button type="button" class="btn-next" onclick="goTo(3)">Suivant<svg viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></button>
    </div>
  </div>
</section>
...
<section class="s step-section" id="section-3">
  <div class="si">
    ...
    <div class="doc-grid">
      ...
      <div class="doc-item">
        <div class="doc-item-head">
          ...
          <div><div class="doc-name">RCCM <span class="doc-badge req">Obligatoire</span></div><div class="doc-desc">Registre du Commerce et du Crédit Mobilier</div></div>
        </div>
      ...
      <div class="doc-item">
        <div class="doc-item-head">
          ...
          <div><div class="doc-name">NIF <span class="doc-badge req">Obligatoire</span></div><div class="doc-desc">Numéro d'Identification Fiscale</div></div>
        </div>
      ...
      <div class="doc-item">
        <div class="doc-item-head">
          ...
          <div><div class="doc-name">Statuts de la société <span class="doc-badge req">Obligatoire</span></div><div class="doc-desc">Acte constitutif signé et enregistré</div></div>
        </div>
      ...
      <div class="doc-item">
        <div class="doc-item-head">
          ...
          <div><div class="doc-name">Pièce d'identité du gérant <span class="doc-badge req">Obligatoire</span></div><div class="doc-desc">CNI, passeport ou titre de séjour en cours de validité</div></div>
        </div>
      ...
      <div class="doc-item">
        <div class="doc-item-head">
          ...
          <div><div class="doc-name">Patente commerciale <span class="doc-badge opt">Facultatif</span></div><div class="doc-desc">Licence d'exercice d'activité commerciale</div></div>
        </div>
        <label class="doc-input" for="f-patente">
          <svg viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
          <span>Choisir un fichier</span>
          <input type="file" id="f-patente" name="doc_patente" accept=".pdf,.jpg,.jpeg,.png" onchange="showFile(this,'fn-patente')"/>
        </label>
      ...
      <div class="doc-item">
        <div class="doc-item-head">
          ...
          <div><div class="doc-name">Attestation de domiciliation <span class="doc-badge opt">Facultatif</span></div><div class="doc-desc">Justificatif du siège social de l'entreprise</div></div>
        </div>
        <label class="doc-input" for="f-domicile">
          <svg viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
          <span>Choisir un fichier</span>
          <input type="file" id="f-domicile" name="doc_domicile" accept=".pdf,.jpg,.jpeg,.png" onchange="showFile(this,'fn-domicile')"/>
        </label>
    ...
    <div class="actions">
      <button type="button" class="btn-prev" onclick="goTo(2)">← Retour</button>
      <button type="button" class="btn-next" onclick="goTo(4)">Vérifier ma demande<svg viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></button>
    </div>
  </div>
</section>
  ...
  <div class="si">
    ...
    <div class="recap-grid">
      ...
      <div class="recap-block">
        ...
        <div class="recap-row"><span>Email</span><span id="r-eemail">—</span></div>
        ...
        <div class="recap-row"><span>Ville / Pays</span><span id="r-evillepays">—</span></div>
      </div>
    ...
    <div class="actions">
      <button type="button" class="btn-prev" onclick="goTo(3)">← Retour</button>
...
</form>{{-- fin du form global --}}

<!-- SUCCÈS -->
<div class="success-s {{ session('success') ? 'show' : '' }}" id="success-section">
  <div class="success-inner">
    <div class="success-ico"><svg viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div>
...
function goTo(step) {
  ...
  if (step === 4) {
    ...
    const docs = [
      ...
      {id:'f-domicile',label:'Attestation domiciliation'},
    ];
