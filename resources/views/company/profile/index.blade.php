...
<div class="page-content">
    ...
    @if(session('success'))
    <div class="alert success" id="alert-success" style="margin-bottom:1.5rem;padding:0.85rem 1.1rem;background:rgba(16,185,129,0.1);border:1px solid rgba(16,185,129,0.3);border-radius:8px;color:#065f46;display:flex;align-items:center;gap:0.6rem;">
        <i class="fas fa-check-circle"></i> {{ session('success') }}
    </div>
    @endif
    @if(session('password_success'))
    <div class="alert success" id="alert-password" style="margin-bottom:1.5rem;padding:0.85rem 1.1rem;background:rgba(16,185,129,0.1);border:1px solid rgba(16,185,129,0.3);border-radius:8px;color:#065f46;display:flex;align-items:center;gap:0.6rem;">
    ...
    <div style="display: grid; grid-template-columns: 280px 1fr; gap: 1.5rem; align-items: start;">
        ...
        {{-- Onglets --}}
        <div>
            <div class="profile-tabs" style="display:flex;gap:0.25rem;margin-bottom:1rem;background:var(--light);padding:0.35rem;border-radius:10px;border:1px solid var(--border);width:fit-content;">
                <button class="profile-tab active" onclick="switchTab('info')" style="padding:0.55rem 1.25rem;border:none;background:var(--white);border-radius:7px;font-size:0.9rem;font-weight:600;cursor:pointer;color:var(--primary);display:flex;align-items:center;gap:0.5rem;box-shadow:0 1px 4px rgba(0,0,0,0.08);" id="tab-info">
...
<style>
    .hidden { display: none; }
    .profile-tab.active { background: var(--white) !important; color: var(--primary) !important; font-weight: 600 !important; box-shadow: 0 1px 4px rgba(0,0,0,0.08); }
    .profile-tab:not(.active):hover { color: var(--dark) !important; }
</style>
